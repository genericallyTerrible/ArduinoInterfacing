 ...
 * @author John
 */
public class jSSC_SerialFrame extends javax.swing.JFrame {
    
    public static SerialPort connectedPort;

    private final String frameTitle = "Serial Terminal v0.01";
    private final String userMessagePreface = "--> ";
    private final String defaultInputFieldText = "Type your message here...";
    ...
    private final int maxGraphPoints = 1000; //Points to be displayed on graph
    private final int timerDelay = 1000; //Time of delay between refreshes in milliseconds

    private String[] portList;
    private final int baudRates[] = {300, 600, 1200, 2400, 4800, 9600, 14400, 19200, 28800, 38400, 57600, 115200, 230400, 250000};
    private final int defaultBaudIndex = 5; //9600
    ...
    private final SerialPortEventListener serialPortReader;

    /**
     * Creates new form jSSC_SerialFrame
     */
    public jSSC_SerialFrame() {
...
//        }
        ...
        rootFrame = (JFrame) SwingUtilities.windowForComponent(connect_JButton);
        ...
        serialPortReader = (SerialPortEvent event) -> {
        ...
        refreshTimer = new Timer(timerDelay, refreshListener);
    ...
    private void connect_JButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connect_JButtonActionPerformed
        ...
        if("Connect".equals(connect_JButton.getText())){
            ...
            int baudRate = baudRates[buadRates_JCombo.getSelectedIndex()];
    ...
    private boolean createConnection(SerialPort chosenPort, int baudRate){
        try {
            ...
            chosenPort.addEventListener(serialPortReader);
            return true;
        } catch (SerialPortException ex) {
            System.out.println(ex);
   ...
   private void updateAutoscroll() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jSSC_SerialFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new jSSC_SerialFrame().setVisible(true);
        });
    }
