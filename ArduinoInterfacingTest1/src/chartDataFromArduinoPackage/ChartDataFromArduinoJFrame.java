 ...
 */
package chartDataFromArduinoPackage;
 ...
 * @author John
 */
public class ChartDataFromArduinoJFrame extends javax.swing.JFrame {
     ...
     */
    public ChartDataFromArduinoJFrame() {
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChartDataFromArduinoJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ChartDataFromArduinoJFrame().setVisible(true);
            }
        });
    }
