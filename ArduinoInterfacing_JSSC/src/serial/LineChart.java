...
public class LineChart extends JPanel {
     ...
     * @param bufferSize Max number of data points to display on the graph at a time. Bear in mind that larger values (>30,000) can begin to cause problems with lag.
     */
    ...
    /**
     * Clears the series storing all the data and therefore the chart displaying it
     */
    public void clear(){
        defaultSeries.clear();
        samples = 0;
